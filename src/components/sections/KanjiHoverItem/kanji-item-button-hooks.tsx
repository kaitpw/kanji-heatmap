...
export const cn =
    "animate-fade-in-fast h-95 w-full p-0.5 sm:p-1 rounded-lg text-2xl border bg-opacity-100 z-0 hover:bg-[#6495ed] transition-all transition-discrete duration-500";
export const loadingCn =
    `${cn} animate-pulse duration-1000 h-full !bg-lime-400 !border border-white dark:border-black`;
