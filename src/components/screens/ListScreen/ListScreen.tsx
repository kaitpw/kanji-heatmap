  ...
  return (
    <>
      ...
      <div className="fix-scroll-layout-shift-right fixed w-full pt-12 pb-2 z-40 bg-background hidden md:block">
        <section className="mx-auto max-w-4xl flex border-0 space-x-1 sticky pt-1 px-2 w-full ">
          <ControlBar />
        </section>
      </div>
      ...
      >
        <section className="mx-auto max-w-4xl flex border-0 space-x-1 pt-1 px-2 w-full">
          <ControlBar />
        </section>
      </div>
      ...
      <div
        className="relative pt-24 pb-20 md:pb-0 -z-0 flex flex-wrap items-center justify-center"
